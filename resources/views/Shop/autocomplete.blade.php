...
{{--                            <button class="btn btn-danger"> SL </button>--}}
                            <a class="btn btn-danger float-right" style="margin: 5px" href="{{route('shop.frommap')}}">Select Location From Map</a>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        ...
        function initialize() {
            ...
            autocomplete.addListener('place_changed', function() {
                ...
                element1.value = (place.geometry['location'].lat());
                element1.name = "lat";
                form.appendChild(element1);

                element2.value = val(place.geometry['location'].lng());
                element2.name = "lng";
                form.appendChild(element2);

                form.method = "GET";
                form.action = "{{route('shop.getshoplocation')}}";
