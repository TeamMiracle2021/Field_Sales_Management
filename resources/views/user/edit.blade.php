                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label for="branch_name" class="col-md-2 col-form-label">Branch Name:</label>
                                    <div class="col-sm-10">
                                        <input id="branch_name" type="text" class="form-control @error('branch_name') is-invalid @enderror" value="{{$user->branch_name}}" value="{{ old('branch_name') }}" name="branch_name" required autocomplete="branch_name" autofocus placeholder="Branch Name">
